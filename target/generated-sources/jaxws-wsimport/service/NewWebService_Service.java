 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8080/CalculatorService/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/CalculatorService/NewWebService?wsdl");
